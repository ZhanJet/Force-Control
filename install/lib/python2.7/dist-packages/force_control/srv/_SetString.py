...
"""autogenerated by genpy from force_control/SetStringRequest.msg. Do not edit."""
import codecs
import sys
...
class SetStringRequest(genpy.Message):
  ...
  _type = "force_control/SetStringRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from force_control/SetStringResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SetStringResponse(genpy.Message):
  ...
  _type = "force_control/SetStringResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# response
bool success
string message
